with airbnb_bordeaux as (
    ...
    from {{ source('AIRBNB_BORDEAUX', 'DBO_REVIEW') }}
...
airbnb_lyon as (
    ...
    from {{ source('AIRBNB_LYON', 'AIRBNB_REVIEW') }}
...
airbnb_paris as (
    ...
    from {{ source('AIRBNB_PARIS', 'AIRBNB_REVIEW') }}
...
airbnb_pays_basque as (
    ...
    from {{ source('AIRBNB_PAYS_BASQUE', 'AIRBNB_REVIEW') }}
